      ...
      >
        ...
        >
          {rows.map(([label, value]) => (
            <View
              key={label}
              style={[md.row, { borderBottomColor: theme.border }]}
            >
              <Text style={[md.rowLabel, { color: theme.subtext }]}>
                {label}
              </Text>
          ...
          <View style={md.actions}>
            ...
            <Pressable
              style={[md.approveBtn, { backgroundColor: AppColors.primary }]}
...
function RequestCard({
  ...
  const voiceColor =
    VOICE_COLORS[item.voice_type?.toLowerCase()] ?? AppColors.primary;
  return (
    <Pressable
      onPress={onPress}
      style={[
    ...
    >
      ...
      <View style={rc.body}>
        ...
        <Text style={[rc.detail, { color: theme.subtext }]}>
          📞 {item.phone}
        </Text>
        <Text style={[rc.detail, { color: theme.subtext }]}>
          🏫 {item.school_name}
            ...
            {processing ? (
              ...
              <>
                <Ionicons
                  ...
                  color="#ef4444"
                />
                <Text style={rc.rejectTxt}>Reject</Text>
              </>
            )}
          </Pressable>
          <Pressable
            style={[rc.approveBtn, { backgroundColor: AppColors.primary }]}
            onPress={onApprove}
            disabled={processing}
          >
            {processing ? (
              ...
              <>
                <Ionicons
                  ...
                  color="#fff"
                />
                <Text style={rc.approveTxt}>Approve</Text>
              </>
            )}
          </Pressable>
        </View>
        <Text style={[rc.tapHint, { color: theme.subtext }]}>
        ...
        {isAdmin && (
          ...
          >
            <Ionicons
              ...
              size={15}
              color={activeTab === "requests" ? "#fff" : theme.subtext}
            />
            <Text
              style={[s.tabTxt, activeTab === "requests" && { color: "#fff" }]}
            >
              Requests
            </Text>
            {pendingCount > 0 && (
